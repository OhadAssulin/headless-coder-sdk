...
OpenCode support is being designed as a direct adapter package. See [docs/opencode-adapter-plan.md](docs/opencode-adapter-plan.md) for the current implementation plan.
